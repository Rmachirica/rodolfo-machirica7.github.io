...
// use the .length property to find the length of string and return the length
...
function toLowerCase(string) {
    // YOUR CODE BELOW HERE //
// use toLowerCase string method to force all characters of string to lowercase
